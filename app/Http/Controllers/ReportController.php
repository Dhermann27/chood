...
use App\Services\DepositReportBuilder;
...
class ReportController extends Controller
{
    public function __construct(
        ...
        private readonly JournalEntryTransformer $journalTransformer,
        private readonly DepositReportBuilder    $depositBuilder,
    )
    {
    }

    public function depositIndex(): Response
    {
        return Inertia::render('DepositFinder/Report');
    }

    public function fetchDeposit(Request $request): JsonResponse
    {
    ...
    public function depositResults($reportId): JsonResponse
    {
        $report = Report::findOrFail($reportId);
        $report->data = $this->depositBuilder->build($report->data ?? []);
        return response()->json($report);
    }

    public function dailyIndex(string $date = null): Response
    {
    ...
    public function dailyDogData(string $date, Request $request): JsonResponse
    {
    ...
    public function journalIndex(): Response
    {
