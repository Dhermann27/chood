...
class Appointment extends Model
{
    ...
    protected $fillable = ['appointment_id', 'order_id', 'pet_id', 'service_id', 'scheduled_start', 'scheduled_end',
        'is_archived', 'google_event_id', 'google_color', 'sync_status', 'completed_at', 'completed_by',
    ...
    protected $casts = [
        ...
        // Backed enums (adjust to your backing types)
